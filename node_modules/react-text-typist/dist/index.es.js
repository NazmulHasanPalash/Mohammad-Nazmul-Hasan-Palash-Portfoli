...
var Typer = function (_a) {
    ...
    var _s = useState(defaultText), text = _s[0], setText = _s[1];
    var _t = useState(false), isDeleting = _t[0], setIsDeleting = _t[1];
    var _u = useState(0), loopNum = _u[0], setLoopNum = _u[1];
    var _v = useState(typingSpeed), writingSpeed = _v[0], setWritingSpeed = _v[1];
    ...
    var styledSpan = useMemo(function () { return ({
        opacity: 0,
    ...
    return (React.createElement("span", { style: style },
        React.createElement("span", { className: className }, text),
        !(refIsFinished.current && hideCursorOnFinish) && (React.createElement("span", { className: "typist-cursor ".concat("".concat(cursorClassName, " ").concat(className)), style: styledSpan }, "|"))));
};
